/**
 * Unit tests for target selection system.
...
describe('Target Selection System', () => {
  ...
  describe('findWeakestEnemy', () => {
    ...
    it('should return null when no living enemies', () => {
      const enemies = [
        createMockUnit('dead1', 2, 2, 0, 100, false),
      ];
  ...
  describe('selectTarget', () => {
    ...
    it('should fallback to nearest when strategy fails', () => {
      const enemies = [
        createMockUnit('only_enemy', 3, 3, 100, 100),
      ];
    ...
    it('should return null when no living enemies', () => {
      const enemies = [
        createMockUnit('dead', 3, 3, 0, 100, false),
      ];
  ...
  describe('selectTargetWithDetails', () => {
    it('should provide detailed information about target selection', () => {
      const attacker = createMockUnit('attacker', 2, 2);
      const enemies = [
        createMockUnit('target', 3, 3, 25, 100),
      ];
